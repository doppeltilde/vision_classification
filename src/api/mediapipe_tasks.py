...
@router.post("/api/mediapipe/pose_landmark_detection", dependencies=[Depends(get_api_key)])
async def classify(
    file: UploadFile = File(...),
    ...
    pose_detected, pose_count, pose_locations, base64img = mediapipe_pose_landmarker_detection(img, save_pose_landmark_file=save_pose_landmark_file)
